...
def main(argv):
    global use_proxy, method, custom_headers, use_jitter, jitter_min, jitter_max, save_log, max_threads, timeout, request_delay
...
{Colors.GREEN}EXAMPLES:{Colors.END}
    ...
    python script.py --url https://httpbin.org/get --no-proxy --jitter 0.5,1.5
